...
IF : IF_SYMBOL LEFT_P EXPRESSIONS RIGHT_P CURLY_LEFT STATEMENTS CURLY_RIGHT ELIF ELSE ;
ELIF : /* lambda */ | ELSE_IF_SYMBOL LEFT_P EXPRESSIONS RIGHT_P CURLY_LEFT STATEMENTS CURLY_RIGHT ELIF;
ELSE : /* lambda */ | ELSE_SYMBOL CURLY_LEFT STATEMENTS CURLY_RIGHT;
...
LOOP : FOR_SYMBOL LEFT_P IDENTIFIER COLON OPTIONAL_DECIMAL COLON DECIMAL COLON OPTIONAL_DECIMAL RIGHT_P CURLY_LEFT LOOP_STATEMENTS CURLY_RIGHT ;
...
FUNC_INPUTS : /* lambda */ | PRIMITIVE_TYPE IDENTIFIER MORE_FUNC_INPUTS;
MORE_FUNC_INPUTS : COMMA PRIMITIVE_TYPE IDENTIFIER MORE_FUNC_INPUTS | /* lambda */;

RETURN_ST : /* lambda */ | RETURN_SYMBOL (IDENTIFIER|DECIMAL|STRING|BOOLEAN|EXPRESSIONS);

FUNC_ARGS : /* lambda */ | (IDENTIFIER|DECIMAL|STRING|BOOLEAN|EXPRESSIONS) MORE_FUNC_ARGS;

MORE_FUNC_ARGS : COMMA (IDENTIFIER|DECIMAL|STRING|BOOLEAN|EXPRESSIONS) MORE_FUNC_ARGS | /* lambda */;
...
OPTIONAL_DECIMAL: DECIMAL | /* lambda */ ;
